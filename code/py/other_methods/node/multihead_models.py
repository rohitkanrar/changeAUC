# This file is a copy of multihead_models.py, which can be found in the following URL:
# https://github.com/xiuheng-wang/NODE_release/blob/main/utils/multihead_models.py
