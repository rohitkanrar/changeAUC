...
# RUN: python code/py/simulation_scripts/simulation_changeAUC.py -d 1 -n 1000 -p 100 -r 100 -g sparse_mean -l local
...
if args.delta == int(args.delta):
    ...
    delta = args.delta
file_name = f"delta_{delta}_p_{args.p}_n_{int(args.n)}_ep_{args.epsilon}_et_{args.eta}_seed_{args.seed}_.pkl"
